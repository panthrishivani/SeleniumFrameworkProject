...
import SeleniumPractice.SeleniumFramework.pageobjects.CheckoutPage;
import SeleniumPractice.SeleniumFramework.pageobjects.Confirmationpage;
...
//      Boolean match = Cart.VerifyProductDisplay(input.get("product"))
    Boolean match = Cart.VerifyProductDisplay(productName);
		...
		//variableName cannot be resolved => If we are using any undefined variable
